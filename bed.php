     ...
     <?php include("carousel.php") ?>
        <main class="main" role="main">
            <div class="main-inner wrapper">
                <ul class="product-list ul-reset">
                    <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur.jpg" alt="">
                            <!-- /.product-item-image -->
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur1.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur2.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur3.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur4.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/tempat tidur5.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
