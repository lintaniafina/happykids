     ...
     <?php include("carousel.php") ?>
        <main class="main" role="main">
            <div class="main-inner wrapper">
                <ul class="product-list ul-reset">
                    <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/food1.jpg" alt="">
                            <!-- /.product-item-image -->
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/food2.png" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/food3.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                    ...
                    <!-- /.product-item-inner -->
                        ...
                        <section class="product-item-inner">
                            <img src="img/img_pr/food4.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/food5.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/food6.jpeg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/food7.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
                ...
                <li class="product-item ib">
                        <section class="product-item-inner">
                            <img src="img/img_pr/food8.jpg" alt="">
                            <!-- /.product-item-image -->
                            <h1 class="product-item-title">
                                nama barang
                          </h1>
